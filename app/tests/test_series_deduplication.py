...
def test_deduplication_logic():
    ...
    # This is based on the user's report of duplicates
    book_titles = [
        "The Goddess Test",
        "Goddess Interrupted",
        "The Goddess Hunt",
        "The Goddess Legacy",
        "Goddess Interrupted"  # DUPLICATE
    ]
    ...
    # Apply the deduplication logic from get_book_series_info()
    seen_titles = {}
    unique_titles = []
    ...
    duplicates_removed = len(book_titles) - len(unique_titles)
...
def main():
    """Run all tests."""
    print("="*70)
    print("  SERIES BOOK DEDUPLICATION TESTS")
    print("="*70)
